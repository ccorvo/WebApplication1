...
public class DiscountCode implements Serializable {
    ...
    private Collection<CustomerData> customerDataCollection;
    ...
    @XmlTransient
    public Collection<CustomerData> getCustomerDataCollection() {
        return customerDataCollection;
    }

    public void setCustomerDataCollection(Collection<CustomerData> customerDataCollection) {
        this.customerDataCollection = customerDataCollection;
    }
    ...
    public String toString() {
        return "testEntities.DiscountCode[ discountCode=" + discountCode + " ]";
    }
